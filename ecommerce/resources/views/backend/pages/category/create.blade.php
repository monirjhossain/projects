                            ...
                            <form role="form" action="{{ route('admin.category.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Parent Category</label>
                                     <select class="form-control" name="parent_id">
                                        ...
                                        @php
                                            $parentCats = App\Models\ParentCategory::all();
                                        @endphp
                                ...
                                <div class="form-group">
                                        <label>Meta description</label>
                                         <textarea name="meta_description" id="" class="form-control" name="meta_description">{{ old('meta_description') }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                        <label>Meta Keyword</label>
                                         <input type="text" name="meta_keyword" placeholder="Enter Meta Keyword" class="form-control" value="{{ old('meta_keyword') }}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                ...
                                <button type="submit" class="btn btn-primary mt-1 pr-4 pl-4">Save category</button>
                                </div>
                            </form>  
