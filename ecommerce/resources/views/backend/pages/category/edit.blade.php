                            ...
                            <form role="form" action="{{ route('admin.category.update', $categories->id) }}" method="POST">
                                ...
                                <div class="col-lg-7">
                                    <div class="form-group">
                                        <label>Name</label>
                                         <input type="text" name="name" placeholder="Enter name" class="form-control" value="{{ $categories->name }}">
                                    </div>
                                <div class="form-group">
                                    <label>Parent Id</label>
                                     <select class="form-control" name="parent_id" value="{{ $categories->parent_id }}">
                                        <option value="0">No parent category</option>
                                        <option value="1">parent 01</option>
                                        <option value="2">parent 02</option>
                                     </select>
                                </div>
                                <div class="form-group">
                                        <label>Meta description</label>
                                         <textarea name="meta_description" id="" class="form-control">{{ $categories->meta_description }}</textarea>
                                </div>
                                <div class="form-group">
                                        <label>Meta Title</label>
                                         <input type="text" name="meta_title" placeholder="Enter meta title" class="form-control" value="{{ $categories->meta_title }}">
                                </div>
                                <div class="form-group">
                                        <label>Meta Keyword</label>
                                         <input type="text" name="meta_keyword" placeholder="Enter Meta Keyword" class="form-control" value="{{ $categories->meta_keyword }}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
